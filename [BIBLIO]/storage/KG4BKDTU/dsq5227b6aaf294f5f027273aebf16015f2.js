...
$h.put(($h.esc || function (s) { return s; })(comment.id));
$h.put(", null)\x3B return false\x22\x3E                \x3C!\x2D\x2D \x3Cimg src\x3D\x22");
...
$h.put("\x22 alt\x3D\x22\x22/\x3E\x2D\x2D\x3E            \x3C/a\x3E        \x3C/div\x3E        \x3Cdiv id\x3D\x22dsq\x2Dcomment\x2Dbody\x2D");
$h.put(($h.esc || function (s) { return s; })(comment.id));
$h.put("\x22 class\x3D\x22dsq\x2Dcomment\x2Dbody\x22\x3E            \x3Cdiv class\x3D\x22dsq\x2Dcomment\x2Dheader     ");
if (comment.parent) { 
$h.put(" dsq\x2Din\x2Dresponse ");
}
$h.put("\x22\x3E                ");
...
$h.put("                \x3C/span\x3E                ");
$h.put("\x3C!\x2D\x2D                \x3Ca href\x3D\x22#\x22 class\x3D\x22dsq\x2Dcollapse\x2Dtoggle dsq\x2Dcollapse\x22 title\x3D\x22");
...
$h.put(")\x3B return false\x3B\x22\x3E\x3Cspan\x3E");
$h.put(trans("Expand"));
$h.put("\x3C/span\x3E\x3C/a\x3E\x2D\x2D\x3E            \x3C/div\x3E            ");
(function () {
var $l = {};
$d.extend($l, $locals);
...
$h.put("\x3Cdiv class\x3D\x22dsqs\x2Dbar\x22\x3E    \x3Ch3 title\x3D\x22    ");
...
$h.put("        ");
$h.put(trans("Showing 1 comment"));
$h.put("        ");
$h.put("      ");
} else {
$h.put("        ");
$h.put($d.interpolate(trans("Showing %(num)s comments"), { "num": thread.num_posts }));
$h.put("        ");
$h.put("      ");
}
$h.put("    ");
}
$h.put("    \x22\x3E    Notes    \x3C/h3\x3E    \x3Cul\x3E    ");
(function () {
var $l = {};
$d.extend($l, $locals);
$d.extend($l, {});
...
$h.put("\x22\x3E    ");
if (!comment) { 
$h.put("        \x3Cdiv id\x3D\x22dsq\x2Daccount\x2Ddropdown\x22\x3E        \x3C!\x2D\x2DTODO: add signup button here\x2D\x2D\x3E            ");
...
$h.put("        \x3C/div\x3E        \x3Cdiv class\x3D\x22dsqs\x2Dbar\x22\x3E        \x3Ch3\x3E");
$h.put(trans("Leave a Note"));
...
$h.put("    \x3Cdiv class\x3D\x22dsq\x2Dtextarea dsq\x2Dtextarea\x2Dreply\x22\x3E        \x3Cdiv class\x3D\x22dsq\x2Dtextarea\x2Dbackground\x22\x3E            \x3Cdiv class\x3D\x22dsq\x2Dtextarea\x2Dwrapper\x22\x3E                \x3C!\x2D\x2D filled dynamically \x2D\x2D\x3E            \x3C/div\x3E            ");
...
if (request.is_authenticated) { 
$h.put("                            \x3Cbutton type\x3D\x22button\x22 id\x3D\x22dsq\x2Dbutton\x2Dsay\x2Dit\x22 class\x3D\x22dsq\x2Dbutton\x22                                onclick\x3D\x22DISQUS.dtpl.actions.fire(\x27comments.send\x27, ");
...
$h.put(", this)\x3B\x22\x3E                                ");
$h.put(trans("Say It"));
$h.put("\x3C!\x2D\x2D \x26hellip\x3B\x2D\x2D\x3E                            \x3C/button\x3E                        ");
}
$h.put("                    \x3C/li\x3E                    \x3C!\x2D\x2D\x3Cli class\x3D\x22dsq\x2Dshare\x2Don dsq\x2Dclearfix\x22\x3E                        ");
(function () {
var $l = {};
$d.extend($l, $locals);
$d.extend($l, {});
...
$h.put("                    \x3C/li\x3E\x2D\x2D\x3E                \x3C/ul\x3E            \x3C/div\x3E        \x3C/div\x3E    \x3C/div\x3E\x3C/div\x3E");
return $h.compile();
...
$h.put("\x3C!\x2D\x2D    \x3Ca href\x3D\x22#\x22 id\x3D\x22dsq\x2Dcomment\x2Dlike\x2Dcount\x2D");
$h.put(($h.esc || function (s) { return s; })(comment.id));
...
$h.put("    \x3Cdiv class\x3D\x22dsq\x2Dcomment\x2Dfooter     ");
if (comment.parent) { 
$h.put(" dsq\x2Din\x2Dresponse ");
}
$h.put("    \x22\x3E        \x3Cul class\x3D\x22dsq\x2Dcomment\x2Dactions\x22\x3E\x3C!\x2D\x2D           ");
if (comment.votable) { 
...
$h.put(($h.esc || function (s) { return s; })(comment.id));
$h.put(", false)\x3B\x22\x3E\x3Cspan\x3EFlag\x3C/span\x3E\x3C/a\x3E            \x3C/li\x3E            ");
}
$h.put("                        ");
...
$h.put("\x3C!\x2D\x2D                \x3Cli\x3E                \x3Ca onclick\x3D\x22DISQUS.dtpl.actions.fire(\x27comments.showParent\x27, ");
...
$h.put("                \x3C/a\x3E                \x3C/li\x3E\x2D\x2D\x3E            ");
}
$h.put("            \x3Cli ");
if (comment.points <= 0) { 
...
$h.put("\x2D\x2D\x3E        \x3C/ul\x3E            \x3C/div\x3E    ");
return $h.compile();
...
$h.put("        \x3C!\x2D\x2D\x3Cdiv id\x3D\x22dsq\x2Dsubscribe\x22\x3E            ");
$h.put("        \x3C/div\x3E\x2D\x2D\x3E    \x3C/ul\x3E    ");
